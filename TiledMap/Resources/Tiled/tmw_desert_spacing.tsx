...
<tileset version="1.2" tiledversion="1.3.3" name="tmw_desert_spacing" tilewidth="32" tileheight="32" spacing="1" margin="1" tilecount="48" columns="8">
 <image source="tmw_desert_spacing.png" width="265" height="199"/>
 <terraintypes>
  <terrain name="t" tile="29"/>
  <terrain name="t1" tile="9"/>
  <terrain name="t2" tile="33"/>
  <terrain name="t3" tile="14"/>
 </terraintypes>
 <tile id="0" terrain="0,0,0,1">
  <properties>
   <property name="type" value="information3"/>
  </properties>
 </tile>
